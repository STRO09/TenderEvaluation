...
const navItems = [
  ...
  { label: 'Tenders',     href: '/gov/tenders',     icon: FileText },
  { label: 'Submissions', href: '/gov/submissions', icon: CheckCircle2 },
];
...
export function GovSidebar({ isOpen, onToggle }: GovSidebarProps) {
